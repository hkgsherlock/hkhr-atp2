...
namespace HKHR_ATP2 {
	...
	public static class SoundManager {
		...
		/// <summary>Plays the sound assigned to the specified inded in a continuous loop.</summary>
		/// <param name="soundIndex">The sound index to play, as defined in the sound configuration file.</param>
		public static void PlayLoop(int soundIndex) {
			Play(soundIndex, 1.0, 1.0, true);
		}
		
		/// <summary>Plays the sound assigned to the specified index once.</summary>
		/// <param name="soundIndex">The sound index to play, as defined in the sound configuration file.</param>
		public static void PlayOnce(int soundIndex) {
		...
		public static void Play(int soundIndex, double volume, double pitch, bool loop) {
			/* Value validation */
		...
		public static void Stop(int soundIndex) {
			if (SoundHandles[soundIndex] != null) {
				SoundHandles[soundIndex].Stop();
		...
		public static bool IsPlaying(int soundIndex) {
